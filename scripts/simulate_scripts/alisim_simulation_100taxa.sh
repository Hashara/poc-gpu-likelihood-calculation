...
tree_file="tree.nwk"
DATASET_DIR="/Users/u7826985/Projects/Nvidia/implementtation/force/poc-gpu-likelihood-calculation/example/test_data_v1/"

# Loop through each taxa folder
for TAXA_DIR in "$DATASET_DIR"{1000,1}taxa; do
